...
venue: "UIUC"        # brief name of host site without address (e.g., "Euphoric State University")
...
startdate: 2017-12-11      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2017-12-12       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Neal and Lizzy"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
{% comment %}
  Instructor workshop traing software/data carpentry
